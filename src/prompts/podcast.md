...
4. **Summarize Key Insights:**
   ...
   This should feel like a casual conversation rather than a formal recap, reinforcing the main takeaways before signing off.
...
Here is the input text for the podcast script:
{context}